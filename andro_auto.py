...
try:
    ...
    script_name = 'andro'
class AndroxgbMEnsemblePipeline:
    def __init__(self, param_file, seed=462, n_splits=5, n_estimators=1000, early_stopping_rounds=100):
        self.SEED = seed
        ...
        with open(param_file, 'r') as f:
            self.xgbm_params = json.load(f)
        self.xgbm_params['n_estimators'] = n_estimators  # Ensure this matches the class parameter
        self.xgbm_params['seed'] = seed  # Ensure this matches the class parameter
    ...
    def train_model(self):
        ...
        for i, (train_idx, val_idx) in enumerate(kf.split(X)):
            ...
            model = xgb.XGBRegressor(**self.xgbm_params)
        ...
        submission.to_csv(f'submission_{script_name}.csv', index=False)
